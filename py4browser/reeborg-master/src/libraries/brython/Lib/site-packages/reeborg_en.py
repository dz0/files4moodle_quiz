...
<ul>
    ...
    "false" if there is no object at Reeborg's location, otherwise
...
<ul>
    ...
    <li><code>think(number)</code>: sets the amount of time in milliseconds between each robot
         action.</li>
    <li><code>World(string)</code>: selects a given world hosted on reeborg.ca</li>
    <li><code>Permalink(string)</code>: selects a world and program hosted on reeborg.ca</li>
